...
red_shield_one = pygame.image.load("RedShields/RedShieldLevelOne")
red_shield_one = pygame.transform.scale(red_shield_one, (60, 60))
red_shield_two = pygame.image.load("RedShields/RedShieldLevelTwo")
red_shield_two = pygame.transform.scale(red_shield_two, (60, 60))
red_shield_three = pygame.image.load("RedShields/RedShieldLevelThree")
red_shield_three = pygame.transform.scale(red_shield_three, (60, 60))
red_shield_four = pygame.image.load("RedShields/RedShieldLevelFour")
red_shield_four = pygame.transform.scale(red_shield_four), (60, 60))
red_shield_five = pygame.image.load("RedShields/RedShieldLevelFive")
red_shield_five = pygame.transform.scale(red_shield_five), (60, 60))
orange_shield_one = pygame.image.load("OrangeShields/OrangeShieldLevelOne")
orange_shield_one = pygame.transform.scale(orange_shield_one, (60, 60))
orange_shield_two = pygame.image.load("OrangeShields/OrangeShieldLevelTwo")
orange_shield_two = pygame.transform.scale(orange_shield_two, (60, 60))
orange_shield_three = pygame.image.load("OrangeShields/OrangeShieldLevelThree")
orange_shield_three = pygame.transform.scale(orange_shield_three, (60, 60))
orange_shield_four = pygame.image.load("OrangeShields/OrangeShieldLevelFour")
orange_shield_four = pygame.transform.scale(orange_shield_four), (60, 60))
orange_shield_five = pygame.image.load("OrangeShields/OrangeShieldLevelFive")
orange_shield_five = pygame.transform.scale(orange_shield_five), (60, 60))
yellow_shield_one = pygame.image.load("YellowShields/YellowShieldLevelOne")
yellow_shield_one = pygame.transform.scale(yellow_shield_one, (60, 60))
yellow_shield_two = pygame.image.load("YellowShields/YellowShieldLevelTwo")
yellow_shield_two = pygame.transform.scale(yellow_shield_two, (60, 60))
yellow_shield_three = pygame.image.load("YellowShields/YellowShieldLevelThree")
yellow_shield_three = pygame.transform.scale(yellow_shield_three, (60, 60))
yellow_shield_four = pygame.image.load("YellowShields/YellowShieldLevelFour")
yellow_shield_four = pygame.transform.scale(yellow_shield_four), (60, 60))
yellow_shield_five = pygame.image.load("YellowShields/YellowShieldLevelFive")
yellow_shield_five = pygame.transform.scale(yellow_shield_five), (60, 60))
green_shield_one = pygame.image.load("GreenShields/GreenShieldLevelOne")
green_shield_one = pygame.transform.scale(green_shield_one, (60, 60))
green_shield_two = pygame.image.load("GreenShields/GreenShieldLevelTwo")
green_shield_two = pygame.transform.scale(green_shield_two, (60, 60))
green_shield_three = pygame.image.load("GreenShields/GreenShieldLevelThree")
green_shield_three = pygame.transform.scale(green_shield_three, (60, 60))
green_shield_four = pygame.image.load("GreenShields/GreenShieldLevelFour")
green_shield_four = pygame.transform.scale(green_shield_four), (60, 60))
green_shield_five = pygame.image.load("GreenShields/GreenShieldLevelFive")
green_shield_five = pygame.transform.scale(green_shield_five), (60, 60))
teal_shield_one = pygame.image.load("TealShields/TealShieldLevelOne")
teal_shield_one = pygame.transform.scale(teal_shield_one, (60, 60))
teal_shield_two = pygame.image.load("TealShields/TealShieldLevelTwo")
teal_shield_two = pygame.transform.scale(teal_shield_two, (60, 60))
teal_shield_three = pygame.image.load("TealShields/TealShieldLevelThree")
teal_shield_three = pygame.transform.scale(teal_shield_three, (60, 60))
teal_shield_four = pygame.image.load("TealShields/TealShieldLevelFour")
teal_shield_four = pygame.transform.scale(teal_shield_four), (60, 60))
teal_shield_five = pygame.image.load("TealShields/TealShieldLevelFive")
teal_shield_five = pygame.transform.scale(teal_shield_five), (60, 60))
blue_shield_one = pygame.image.load("BlueShields/BlueShieldLevelOne")
blue_shield_one = pygame.transform.scale(blue_shield_one, (60, 60))
blue_shield_two = pygame.image.load("BlueShields/BlueShieldLevelTwo")
blue_shield_two = pygame.transform.scale(blue_shield_two, (60, 60))
blue_shield_three = pygame.image.load("BlueShields/BlueShieldLevelThree")
blue_shield_three = pygame.transform.scale(blue_shield_three, (60, 60))
blue_shield_four = pygame.image.load("BlueShields/BlueShieldLevelFour")
blue_shield_four = pygame.transform.scale(blue_shield_four), (60, 60))
blue_shield_five = pygame.image.load("BlueShields/BlueShieldLevelFive")
blue_shield_five = pygame.transform.scale(blue_shield_five), (60, 60))
purple_shield_one = pygame.image.load("PurpleShields/PurpleShieldLevelOne")
purple_shield_one = pygame.transform.scale(purple_shield_one, (60, 60))
purple_shield_two = pygame.image.load("PurpleShields/PurpleShieldLevelTwo")
purple_shield_two = pygame.transform.scale(purple_shield_two, (60, 60))
purple_shield_three = pygame.image.load("PurpleShields/PurpleShieldLevelThree")
purple_shield_three = pygame.transform.scale(purple_shield_three, (60, 60))
purple_shield_four = pygame.image.load("PurpleShields/PurpleShieldLevelFour")
purple_shield_four = pygame.transform.scale(purple_shield_four), (60, 60))
purple_shield_five = pygame.image.load("PurpleShields/PurpleShieldLevelFive")
purple_shield_five = pygame.transform.scale(purple_shield_five), (60, 60))
pink_shield_one = pygame.image.load("PinkShields/PinkShieldLevelOne")
pink_shield_one = pygame.transform.scale(pink_shield_one, (60, 60))
pink_shield_two = pygame.image.load("PinkShields/PinkShieldLevelTwo")
pink_shield_two = pygame.transform.scale(pink_shield_two, (60, 60))
pink_shield_three = pygame.image.load("PinkShields/PinkShieldLevelThree")
pink_shield_three = pygame.transform.scale(pink_shield_three, (60, 60))
pink_shield_four = pygame.image.load("PinkShields/PinkShieldLevelFour")
pink_shield_four = pygame.transform.scale(pink_shield_four), (60, 60))
pink_shield_five = pygame.image.load("PinkShields/PinkShieldLevelFive")
pink_shield_five = pygame.transform.scale(pink_shield_five), (60, 60))
brown_shield_one = pygame.image.load("BrownShields/BrownShieldLevelOne")
brown_shield_one = pygame.transform.scale(brown_shield_one, (60, 60))
brown_shield_two = pygame.image.load("BrownShields/BrownShieldLevelTwo")
brown_shield_two = pygame.transform.scale(brown_shield_two, (60, 60))
brown_shield_three = pygame.image.load("BrownShields/BrownShieldLevelThree")
brown_shield_three = pygame.transform.scale(brown_shield_three, (60, 60))
brown_shield_four = pygame.image.load("BrownShields/BrownShieldLevelFour")
brown_shield_four = pygame.transform.scale(brown_shield_four), (60, 60))
brown_shield_five = pygame.image.load("BrownShields/BrownShieldLevelFive")
brown_shield_five = pygame.transform.scale(brown_shield_five), (60, 60))
white_shield_one = pygame.image.load("WhiteShields/WhiteShieldLevelOne")
white_shield_one = pygame.transform.scale(white_shield_one, (60, 60))
white_shield_two = pygame.image.load("WhiteShields/WhiteShieldLevelTwo")
white_shield_two = pygame.transform.scale(white_shield_two, (60, 60))
white_shield_three = pygame.image.load("WhiteShields/WhiteShieldLevelThree")
white_shield_three = pygame.transform.scale(white_shield_three, (60, 60))
white_shield_four = pygame.image.load("WhiteShields/WhiteShieldLevelFour")
white_shield_four = pygame.transform.scale(white_shield_four), (60, 60))
white_shield_five = pygame.image.load("WhiteShields/WhiteShieldLevelFive")
white_shield_five = pygame.transform.scale(white_shield_five), (60, 60))
black_shield_one = pygame.image.load("BlackShields/BlackShieldLevelOne")
black_shield_one = pygame.transform.scale(black_shield_one, (60, 60))
black_shield_two = pygame.image.load("BlackShields/BlackShieldLevelTwo")
black_shield_two = pygame.transform.scale(black_shield_two, (60, 60))
black_shield_three = pygame.image.load("BlackShields/BlackShieldLevelThree")
black_shield_three = pygame.transform.scale(black_shield_three, (60, 60))
black_shield_four = pygame.image.load("BlackShields/BlackShieldLevelFour")
black_shield_four = pygame.transform.scale(black_shield_four), (60, 60))
black_shield_five = pygame.image.load("BlackShields/BlackShieldLevelFive")
black_shield_five = pygame.transform.scale(black_shield_five), (60, 60))
bronze_shield_one = pygame.image.load("BronzeShields/BronzeShieldLevelOne")
bronze_shield_one = pygame.transform.scale(bronze_shield_one, (60, 60))
bronze_shield_two = pygame.image.load("BronzeShields/BronzeShieldLevelTwo")
bronze_shield_two = pygame.transform.scale(bronze_shield_two, (60, 60))
bronze_shield_three = pygame.image.load("BronzeShields/BronzeShieldLevelThree")
bronze_shield_three = pygame.transform.scale(bronze_shield_three, (60, 60))
bronze_shield_four = pygame.image.load("BronzeShields/BronzeShieldLevelFour")
bronze_shield_four = pygame.transform.scale(bronze_shield_four), (60, 60))
bronze_shield_five = pygame.image.load("BronzeShields/BronzeShieldLevelFive")
bronze_shield_five = pygame.transform.scale(bronze_shield_five), (60, 60))
silver_shield_one = pygame.image.load("SilverShields/SilverShieldLevelOne")
silver_shield_one = pygame.transform.scale(silver_shield_one, (60, 60))
silver_shield_two = pygame.image.load("SilverShields/SilverShieldLevelTwo")
silver_shield_two = pygame.transform.scale(silver_shield_two, (60, 60))
silver_shield_three = pygame.image.load("SilverShields/SilverShieldLevelThree")
silver_shield_three = pygame.transform.scale(silver_shield_three, (60, 60))
silver_shield_four = pygame.image.load("SilverShields/SilverShieldLevelFour")
silver_shield_four = pygame.transform.scale(silver_shield_four), (60, 60))
silver_shield_five = pygame.image.load("SilverShields/SilverShieldLevelFive")
silver_shield_five = pygame.transform.scale(silver_shield_five), (60, 60))
gold_shield_one = pygame.image.load("GoldShields/GoldShieldLevelOne")
gold_shield_one = pygame.transform.scale(gold_shield_one, (60, 60))
gold_shield_two = pygame.image.load("GoldShields/GoldShieldLevelTwo")
gold_shield_two = pygame.transform.scale(gold_shield_two, (60, 60))
gold_shield_three = pygame.image.load("GoldShields/GoldShieldLevelThree")
gold_shield_three = pygame.transform.scale(gold_shield_three, (60, 60))
gold_shield_four = pygame.image.load("GoldShields/GoldShieldLevelFour")
gold_shield_four = pygame.transform.scale(gold_shield_four), (60, 60))
gold_shield_five = pygame.image.load("GoldShields/GoldShieldLevelFive")
gold_shield_five = pygame.transform.scale(gold_shield_five), (60, 60))
diamond_shield_one = pygame.image.load("DiamondShields/DiamondShieldLevelOne")
diamond_shield_one = pygame.transform.scale(diamond_shield_one, (60, 60))
diamond_shield_two = pygame.image.load("DiamondShields/DiamondShieldLevelTwo")
diamond_shield_two = pygame.transform.scale(diamond_shield_two, (60, 60))
diamond_shield_three = pygame.image.load("DiamondShields/DiamondShieldLevelThree")
diamond_shield_three = pygame.transform.scale(diamond_shield_three, (60, 60))
diamond_shield_four = pygame.image.load("DiamondShields/DiamondShieldLevelFour")
diamond_shield_four = pygame.transform.scale(diamond_shield_four), (60, 60))
diamond_shield_five = pygame.image.load("DiamondShields/DiamondShieldLevelFive")
diamond_shield_five = pygame.transform.scale(diamond_shield_five), (60, 60))

earthtank = pygame.image.load("Tanks2/EarthTank.png")
earthtank = pygame.transform.scale(earthtank, (40, 40))
electrictank = pygame.image.load("Tanks2/ElectricTank.png")
electrictank = pygame.transform.scale(electrictank, (40, 40))
firetank = pygame.image.load("Tanks2/FireTank.png")
firetank = pygame.transform.scale(firetank, (40, 40))
grasstank = pygame.image.load("Tanks2/GrassTank.png")
grasstank = pygame.transform.scale(grasstank, (40, 40))
icetank = pygame.image.load("Tanks2/IceTank.png")
icetank = pygame.transform.scale(icetank, (40, 40))
plasmatank = pygame.image.load("Tanks2/PlasmaTank.png")
plasmatank = pygame.transform.scale(plasmatank, (40, 40))
watertank = pygame.image.load("Tanks2/WaterTank.png")
